...
const MAX_RPM = 150;
const MAX_CV = 2;
export const writeIPData = async (data, redis) => {
...
export const IPFeatures = async (ip, redis) => {
...
export const IPRiskScore = async (ip, redis) => {
...
//# sourceMappingURL=ip.Engine.js.map