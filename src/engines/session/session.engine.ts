...
export const writeSessionData = async (data: SessionStructure, redis: Redis): Promise<void> => {
...
export const SessionFeature = async (sessionId: string, redis: Redis) => {
...
export const SessionRiskScore = async (sessionId: string, redis: Redis): Promise<number> => {
